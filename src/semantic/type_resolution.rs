...
fn resolve_expression_values_and_update_data_type(
...
fn resolve_term_values_and_update_data_type(
    term: &mut Term,
    function_header_map: &FunctionTable,
    symbol_table: &SymbolTable,
) {
...
fn resolve_unary_values_and_update_data_type(
    unary: &mut Unary,
    function_header_map: &FunctionTable,
    symbol_table: &SymbolTable,
) {
